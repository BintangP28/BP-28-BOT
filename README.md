...
```bash
> git clone https://github.com/BintangP28/BP-28-BOT
> cd BP-28-BOT
```
...
### Information <img src="https://github.com/TheDudeThatCode/TheDudeThatCode/blob/master/Assets/hmm.gif" width="29px">
